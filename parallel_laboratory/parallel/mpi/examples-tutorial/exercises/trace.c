...
*/
  ...
  PMPI_Comm_rank( MPI_COMM_WORLD, &llrank );
  printf( "[%d] Starting MPI_Bsend_init...\n", llrank ); fflush( stdout );
...
*/
  ...
  PMPI_Comm_rank( MPI_COMM_WORLD, &llrank );
  printf( "[%d] Starting MPI_Recv_init...\n", llrank ); fflush( stdout );
...
*/
  ...
  PMPI_Comm_rank( MPI_COMM_WORLD, &llrank );
  printf( "[%d] Starting MPI_Send_init...\n", llrank ); fflush( stdout );
...
*/
  ...
  PMPI_Comm_rank( MPI_COMM_WORLD, &llrank );
  printf( "[%d] Starting MPI_Rsend_init...\n", llrank ); fflush( stdout );
...
*/
  ...
  PMPI_Comm_rank( MPI_COMM_WORLD, &llrank );
  printf( "[%d] Starting MPI_Sendrecv...\n", llrank ); fflush( stdout );
...
*/
  ...
  PMPI_Comm_rank( MPI_COMM_WORLD, &llrank );
  printf( "[%d] Starting MPI_Sendrecv_replace...\n", llrank ); fflush( stdout );
...
*/
  ...
  PMPI_Comm_rank( MPI_COMM_WORLD, &llrank );
  printf( "[%d] Starting MPI_Ssend_init...\n", llrank ); fflush( stdout );
