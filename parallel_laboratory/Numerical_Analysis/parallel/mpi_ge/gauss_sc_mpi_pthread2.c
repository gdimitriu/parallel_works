...
//	printf("send3 %d at %d from %d row %d\n",data->rank,l,data->temp[1],data->temp[0]);fflush(stdout);
...
//		printf("rec1 %d from %d row %d\n",data->rank,data->temp[1],data->temp[0]);fflush(stdout);
