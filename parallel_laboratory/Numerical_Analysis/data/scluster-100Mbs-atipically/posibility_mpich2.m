...
plot(distrib_mpich2_2(:,1),distrib_mpich2_2(:,4),'red',distrib_mpich2_2(:,1),distrib_mpich2_3(:,4),'blue',distrib_mpich2_2(:,1),distrib_mpich2_4(:,4),'green',distrib_mpich2_2(:,1),distrib_mpich2_5(:,4),'cyan',dual_jr_gcc(:,1),p3_jr_gcc(:,4),'x');
